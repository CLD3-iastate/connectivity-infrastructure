                                    ...
                                    fluidRow(style = "margin: 6px",
                                             ...
                                             column(8,
                                                    wellPanel(
                                                      ...
                                                      p("We invite you to explore our", a(href = 'http://bband.policy-analytics.net', 'broadband internet data source comparison dashboard.', target = "_blank"), "The dashboard visualizes discrepancies between FCC-reported broadband availability and ACS-reported broadband subscription at census block 
